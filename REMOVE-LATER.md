...
Ensure that the state of the game is restored on page reload/navigation.

- The backend estimates the winner based on the rolls and holds, and enforces time if needed. 
...
- Wrap the game board component in a React component if necessary. 
