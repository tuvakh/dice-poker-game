...
export default function Terms() {
    return (
        <section className="information-page">
            ...
            <p className="information-page__updated">Last updated: April 18, 2026</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Spanish dice poker.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Spanish dice poker, accessible from <a href="http://localhost:5173/" rel="external nofollow noopener" target="_blank">http://localhost:5173/</a></p>
                </li>
                <li>
            ...
            <h2>User Accounts</h2>
            <p>Users must provide a username and email to register. You must be at least 18 years old to create an account.</p>
            ...
            <h2>Contact Us</h2>
            <p>Feel free to contact us if you have any questions about these Terms and Conditions</p>
        </section>
    );
}